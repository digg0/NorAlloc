...
@router.put("/id/{curso_id}", response_model=CursoResponse)
...
@router.delete("/id/{curso_id}", response_model=CursoResponse)
...
@router.put("/id/{curso_id}/reativar", response_model=CursoResponse)
